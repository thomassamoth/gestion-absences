...
public class ValidationAbsencesGUI {
	...
	private void initialize(Utilisateur util) {
		...
		JLabel test_icon = new JLabel(new ImageIcon("C:\\Users\\Thomas\\Documents\\&ESIGELEC\\2022-2023 - 1A\\PDL\\pdl\\img\\icon_user.png"));
	...
	/**
	 * Affiche les composants principaux de la fenêtre
	 */
	public void affichageCompPrincipaux() {
