...
public class GestionAbsence {
	...
	private void initialize() {
		...
		buttonConnexion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(champIdentifiant.getText().length() <= 0 || String.valueOf(passwordField.getPassword()).length() <= 0) {
	...
	/**
	 * Vérifie les bons identifiants de l'utilisateur et affiche la fenetre suivante en fonction de son statut.
	 * @param username
	 * @param password
	 */
		...
		if(user != null) {	
			...
			switch (utilisateurStatut) {
				case 1:
					...
					new ValidationAbsences();
					break;
					
				case 2:
					JOptionPane.showMessageDialog(null,"Pas encore de fenêtre disponible pour les enseignants.", "Information", JOptionPane.INFORMATION_MESSAGE);
					break;
				
				case 3: 
					JOptionPane.showMessageDialog(null,"Pas encore de fenêtre disponible pour les élèves.", "Information", JOptionPane.INFORMATION_MESSAGE);
					break;
				
				default:
					JOptionPane.showMessageDialog(null,"Error : cet utilisateur n'a pas de statut. ", "Error", JOptionPane.ERROR_MESSAGE);
					break;
			}
		}
	}
